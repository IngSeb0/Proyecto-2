...
import modelo.facturacion.Consignacion;
import modelo.facturacion.Venta;
...
import persistencia.CentralPersitencia;
...
public class Galeria {
	...
	private CentralPersitencia centralPersistencia;
	...
	public Galeria() {
		...
		if (centralPersistencia.getGaleria() != null) {
			...
			viewRegistro.registrarNuevoUsuario("Administrador");
...
//		centralPersistencia.guardarUsuarios();
	...
	public CentralPersitencia getCentralPersistencia() {
		return centralPersistencia;
	}

	public void setCentralPersistencia(CentralPersitencia centralPersistencia) {
